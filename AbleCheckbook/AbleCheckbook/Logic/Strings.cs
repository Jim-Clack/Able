...
namespace AbleCheckbook.Logic
{
    ...
    public static class Strings
    {
        ...
        private static void LoadHardCodedDefaults()
        {
            ...
            AddString("First Name on CC");
            AddString("Last Name on CC");
            AddString("Street Address");
            AddString("Apt Number");
            AddString("City (per USPS)");
            AddString("State (2-letters)");
            AddString("Zip/Postal Code");
            AddString("Country Code");
            AddString("Phone (10+ digits)");
            AddString("Email Address");
            AddString("Credit Card Num");
            AddString("CVV2 (Help)");
            AddString("Expiration Month");
            AddString("Expiration Year");
            AddString("Purchase");
            AddString("Cancel");
            AddString("Add New");
            AddString("Due");
